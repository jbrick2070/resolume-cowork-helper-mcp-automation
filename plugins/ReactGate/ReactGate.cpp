...
static CFFGLPluginInfo PluginInfo(
	PluginFactory< ReactGate >,                                                    // Create method
	"FGTE",                                                                        // Plugin unique ID of maximum length 4.
	"React Gate",                                                                  // Plugin name
	...
	lastHostTime( 0.0 ), localTime( 0.0 )
{
	...
	FFGLLog::LogToHost( "Created React Gate effect" );
}
ReactGate::~ReactGate()
{
}

FFResult ReactGate::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult ReactGate::ProcessOpenGL( ProcessOpenGLStruct* pGL )
{
...
FFResult ReactGate::SetFloatParameter( unsigned int dwIndex, float value )
{
	switch( dwIndex )
	{
	case PT_WEAVE:
...
float ReactGate::GetFloatParameter( unsigned int index )
{
	switch( index )
	{
	case PT_WEAVE:
