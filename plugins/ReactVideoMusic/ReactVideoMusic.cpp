...
static CFFGLPluginInfo PluginInfo(
	PluginFactory< ReactVideoMusic >,                                              // Create method
	"FAVM",                                                                        // Plugin unique ID of maximum length 4.
	"React Video Music",                                                           // Plugin name
...
ReactVideoMusic::ReactVideoMusic() :
	...
	lastHostTime( 0.0 ), localTime( 0.0 )
{
	...
	FFGLLog::LogToHost( "Created React Video Music source" );
}
ReactVideoMusic::~ReactVideoMusic()
{
}

FFResult ReactVideoMusic::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult ReactVideoMusic::ProcessOpenGL( ProcessOpenGLStruct* pGL )
{
...
FFResult ReactVideoMusic::DeInitGL()
{
...
FFResult ReactVideoMusic::SetFloatParameter( unsigned int dwIndex, float value )
{
	switch( dwIndex )
	{
	case PT_LEVEL:
...
float ReactVideoMusic::GetFloatParameter( unsigned int index )
{
	switch( index )
	{
	case PT_LEVEL:
