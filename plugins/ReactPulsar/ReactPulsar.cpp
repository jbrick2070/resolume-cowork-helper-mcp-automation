...
static CFFGLPluginInfo PluginInfo(
	PluginFactory< ReactPulsar >,                                                  // Create method
	"FPLS",                                                                        // Plugin unique ID of maximum length 4.
	"React Pulsar",                                                                // Plugin name
	...
	lastHostTime( 0.0 ), localTime( 0.0 ), phaseAcc( 0.0 )
{
	...
	FFGLLog::LogToHost( "Created React Pulsar source" );
}
ReactPulsar::~ReactPulsar()
{
}

FFResult ReactPulsar::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult ReactPulsar::ProcessOpenGL( ProcessOpenGLStruct* pGL )
{
...
FFResult ReactPulsar::SetFloatParameter( unsigned int dwIndex, float value )
{
	switch( dwIndex )
	{
	case PT_LEVEL:
...
float ReactPulsar::GetFloatParameter( unsigned int index )
{
	switch( index )
	{
	case PT_LEVEL:
