...
static CFFGLPluginInfo PluginInfo(
	PluginFactory< ReactAnamorphic >,                                              // Create method
	"FANA",                                                                        // Plugin unique ID of maximum length 4.
	"React Anamorphic",                                                            // Plugin name
...
ReactAnamorphic::ReactAnamorphic() :
	...
	lastHostTime( 0.0 ), localTime( 0.0 )
{
	...
	FFGLLog::LogToHost( "Created React Anamorphic effect" );
}
ReactAnamorphic::~ReactAnamorphic()
{
}

FFResult ReactAnamorphic::InitGL( const FFGLViewportStruct* vp )
{
...
FFResult ReactAnamorphic::ProcessOpenGL( ProcessOpenGLStruct* pGL )
{
...
FFResult ReactAnamorphic::DeInitGL()
{
...
FFResult ReactAnamorphic::SetFloatParameter( unsigned int dwIndex, float value )
{
	switch( dwIndex )
	{
	case PT_STREAK:
...
float ReactAnamorphic::GetFloatParameter( unsigned int index )
{
	switch( index )
	{
	case PT_STREAK:
