# React Optics — A Little Museum of Moving-Image Machines
...
## Placard 1 — React Gate (1895) — EFFECT, id FGTE
...
## Placard 2 — React Anamorphic (1953) — EFFECT, id FANA
...
## Placard 3 — React Scanline (1972) — EFFECT, id FSCN
...
## Placard 4 — React Video Music (1977) — SOURCE, id FAVM
